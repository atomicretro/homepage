...
`;function wn(e){const{children:t,className:n}=e,{showExplanation:r}=Ma();return c.jsx(sy,{className:n,$blur:r,children:t})}const ay=D.div`
  position: absolute;
  top: -10px;
  height: 100%;
  width: 100%;
...
`;function kn(e){const{children:t,number:n}=e,{showContent:r}=et(),{showExplanation:o}=Ma();return c.jsx(ay,{$show:o,children:c.jsxs("div",{className:"reading",children:[t,n&&c.jsx("p",{children:c.jsx(Wt,{tabIndex:r&&o?"0":"-1",to:`https://100dayscss.com/days/${n}`,children:"To the challenge!"})})]})})}const uy=D.div`
  display: flex;
  flex-direction: row;
  justify-content: center;
...
`;function r1(){const{pickRandomPalette:e}=we(),{handleBackgroundInteraction:t,showContent:n}=et(),r=o=>{o.stopPropagation(),e()};return c.jsxs(n1,{onClick:()=>t(!0),tabIndex:n?"-1":"0",children:[c.jsx(e1,{}),c.jsx(mc,{className:"main-button random",onClick:r,children:"Random palette"}),c.jsx(mc,{className:"main-button enter",tabIndex:n?"-1":"0",children:"Click to enter"})]})}const o1=e=>{const t=e.backingStorePixelRatio||e.webkitBackingStorePixelRatio||e.mozBackingStorePixelRatio||e.msBackingStorePixelRatio||e.oBackingStorePixelRatio||e.backingStorePixelRatio||1;return(window.devicePixelRatio||1)/t},i1=(e,t)=>{const n=o1(t),r=getComputedStyle(e).getPropertyValue("width").slice(0,-2),o=getComputedStyle(e).getPropertyValue("height").slice(0,-2);e.width=r*n,e.height=o*n,e.style.width=`${r}px`,e.style.height=`${o}px`},l1=1e3,s1=D.canvas`
  ...
  position: absolute;
  z-index: -4;
`;class a1{constructor({alpha:t,alphaStep:n,size:r,x:o,y:i}){Da(this,"updateAlpha",()=>{let t=this.alpha+this.alphaStep;t>=1?(t=1,this.alphaStep*=-1):t<=0&&(t=0,this.alphaStep*=-1),this.alpha=t});this.alpha=t,this.alphaStep=n,this.size=r,this.x=o,this.y=i}}function u1(e){const{currentPalette:t}=e,n=M.useRef(),[r,o]=M.useState([]);return M.useEffect(()=>{const i=n.current,l=i.getContext("2d");i1(i,l)},[]),M.useEffect(()=>{const i=n.current,l=[];for(let s=0;s<l1;s++){const a=tn(1,5);let u=tn(5,30/a)/3e3;u*=tn(1,3)===1?-1:1;const f=new a1({alpha:Math.random(),alphaStep:u,size:tn(1,5),x:tn(1,i.width),y:tn(1,i.height)});l.push(f)}o(l)},[]),M.useEffect(()=>{const l=n.current.getContext("2d");let s;const a=()=>{for(let u=0;u<r.length;u++){const f=r[u];l.clearRect(f.x,f.y,f.size,f.size),f.updateAlpha(),l.fillStyle=t.secondary,l.globalAlpha=f.alpha,l.fillRect(f.x,f.y,f.size,f.size)}s=requestAnimationFrame(a)};return a(),()=>{cancelAnimationFrame(s)}}),c.jsx(s1,{ref:n})}const c1=D.div`
  height: 100%;
  width: 100%;
  position: absolute;
  background-color: ${({$colors:e})=>e.primary};
