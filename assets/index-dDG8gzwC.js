...
`;function uy(){const{handleBackgroundInteraction:e}=et(),t=n=>{n.stopPropagation(),e(!1)};return c.jsx(ay,{onClick:t,children:c.jsx("h1",{onClick:n=>n.stopPropagation(),children:"Alec Cuccia"})})}const mp=M.createContext(),cy=e=>{const[t,n]=M.useState(!1),r=M.useCallback(()=>{n(i=>!i)},[n]),o={showExplanation:t,toggleExplanation:r};return c.jsx(mp.Provider,{value:o,children:e.children})},Ma=()=>{const e=M.useContext(mp);if(!e)throw new Error("Challenges context misconfigured");return e},dy=D.a`
  &:link, &:visited {
...
`;function Wt(e){const{children:t,className:n,tabIndex:r,to:o}=e,{tabIndex:i}=et(),{currentPalette:l}=we();let s={};return o.includes("mailto")===!1&&(s={rel:"noopener noreferrer",target:"_blank"}),c.jsx(dy,{className:n,href:o,onMouseUp:a=>a.currentTarget.blur(),tabIndex:r||i,...s,$colors:l,children:t})}const fy=D.div`
  display: flex;
...
`;function py(){return c.jsxs(fy,{children:[c.jsx(Wt,{to:"mailto:ajcuccia+dev@gmail.com",children:"Email"}),c.jsx(Wt,{to:"https://www.github.com/atomicretro",children:"GitHub"}),c.jsx(Wt,{to:"https://www.linkedin.com/in/alec-cuccia",children:"LinkedIn"})]})}const Fa=D.button`
  background: none;
  color: inherit;
  border: none;
  padding: 0;
...
`;function gp(e){const{children:t,className:n,onClick:r}=e,{tabIndex:o}=et(),{currentPalette:i}=we();return c.jsx(hy,{className:n,onClick:r,onMouseUp:l=>l.currentTarget.blur(),tabIndex:o,$colors:i,children:t})}const my=D(K0)`
  &:link, &:visited {
    color: ${({$colors:e})=>e.link};
  }
...
`;function Fe(e){const{children:t,className:n,to:r}=e,{tabIndex:o}=et(),{currentPalette:i}=we();return c.jsx(my,{className:n,onMouseUp:l=>l.currentTarget.blur(),tabIndex:o,to:r,$colors:i,children:t})}const gy=D.div`
  ${({$blur:e})=>e&&"filter: blur(5px);"}
  transition: filter 0.5s ease;
`;function xn(e){const{children:t,className:n}=e,{showExplanation:r}=Ma();return c.jsx(gy,{className:n,$blur:r,children:t})}const yy=D.div`
  position: absolute;
  top: -10px;
  height: 100%;
  width: 100%;
...
`;function wn(e){const{children:t,number:n}=e,{showContent:r}=et(),{showExplanation:o}=Ma();return c.jsx(yy,{$show:o,children:c.jsxs("div",{className:"reading",children:[t,n&&c.jsx("p",{children:c.jsx(Wt,{tabIndex:r&&o?"0":"-1",to:`https://100dayscss.com/days/${n}`,children:"To the challenge!"})})]})})}const vy=D.div`
  display: flex;
  flex-direction: row;
  justify-content: center;
...
`,xy={129:!0,186:!0,212:!0,130:!0,187:!0,213:!0,148:!0,189:!0,228:!0,149:!0,190:!0,231:!0,150:!0,192:!0,247:!0,151:!0,193:!0,249:!0,167:!0,206:!0,250:!0,168:!0,207:!0,252:!0,169:!0,208:!0,266:!0,170:!0,209:!0,268:!0,171:!0,210:!0,271:!0,172:!0,211:!0,273:!0},wy=c.jsxs(c.Fragment,{children:[c.jsx("p",{children:"Click the squares to swap them on and off."}),c.jsx("div",{className:"explanation-line"}),c.jsx("p",{children:`At first I had no idea how I was going to complete this challenge, and walked away from it to do other things. Hours later, thinking about something else entirely, it hit me: "they're all checkboxes!"`}),c.jsx("p",{children:"Once I realized that, writing the code was straightforward. I used JS to create the series of checkboxes, but then used vanilla CSS to arrange them and style them into pixels."}),c.jsx("p",{children:`The default image was brute-forced by figuring out which pixels are white in the demo template, and simply marking them "unchecked" as they are generated. It's low-tech, but since the default image is static I don't mind cheesing it a bit.`})]});function ky(){const{currentPalette:e}=we();return c.jsxs(vy,{$colors:e,children:[c.jsx(wn,{number:"47",children:wy}),c.jsx(xn,{className:"alien",children:[...Array(400).keys()].map(t=>c.jsx("input",{className:"pixel",defaultChecked:!xy[t],onMouseUp:n=>n.target.blur(),type:"checkbox"},t))})]})}const Sy=qg`
  0%   { top: -6px; }
  10%  { top: -56px; }
  20%  { top: -106px; }
  30%  { top: -156px; }
...
`,_y=c.jsxs(c.Fragment,{children:[c.jsx("p",{children:"Click the circle to watch a flower bloom."}),c.jsx("div",{className:"explanation-line"}),c.jsx("p",{children:"This one was deceptively easy."}),c.jsx("p",{children:"The main part of the flower — the circle — is simply a checkbox; unfilled is unchecked, filled is checked. The petals that fly off are just divs styled to be short lines. I got them to move using a series of animations that trigger when the checkbox gets clicked (thank you general sibling combinator!)."}),c.jsx("p",{children:"The hard part was all the trigonometry I had to do to get the petals in the right positions. Each petal is basically the same line rotated around the center of the flower; using trig I was able to plot their trajectories away from the center evenly. There might be a less math-heavy way of doing this, but because the animations are just moving along straight lines that I already calculated, this way is definitely efficient!"})]});function Ny(){const{currentPalette:e}=we();return c.jsxs(Py,{$colors:e,children:[c.jsx(wn,{number:"66",children:_y}),c.jsxs(xn,{className:"flower",children:[c.jsx("input",{className:"stem",defaultChecked:!1,onMouseUp:t=>t.target.blur(),type:"checkbox"}),c.jsxs("div",{className:"petals",children:[c.jsx("div",{className:"petal n01"}),c.jsx("div",{className:"petal n02"}),c.jsx("div",{className:"petal n03"}),c.jsx("div",{className:"petal n04"}),c.jsx("div",{className:"petal n05"}),c.jsx("div",{className:"petal n06"}),c.jsx("div",{className:"petal n07"}),c.jsx("div",{className:"petal n08"}),c.jsx("div",{className:"petal n09"}),c.jsx("div",{className:"petal n10"}),c.jsx("div",{className:"petal n11"}),c.jsx("div",{className:"petal n12"})]})]})]})}const yp=200,hc=e=>{let t="";for(let n=1;n<=yp*2;n++)t+=`
...
`,Iy=c.jsxs(c.Fragment,{children:[c.jsx("p",{children:"Hover over the word to obfuscate the message."}),c.jsx("div",{className:"explanation-line"}),c.jsx("p",{children:"After going through some other challenges I've picked up on how to handle pure CSS interactivity."}),c.jsx("p",{children:"The background is a series of horizontal grey slivers which, when hovered, increase the height of the foreground orange overlay. The slivers are created with JS, but that's the only JS used. Each sliver gets an index number, and the height of the orange overlay is simply a multiple of whichever sliver is being hovered at the moment."}),c.jsx("p",{children:"To achieve the blur effect on the text I've stacked two spans on top of each other with different z-indices. The higher z-index text has a blur filter while the lower text does not. The order goes: grey background, non-blurred text, orange overlay, blurred text. This causes the non-blurred text to get hidden by the orange layer, leaving only the blurred effect."})]});function zy(){const{tabIndex:e}=et(),{currentPalette:t}=we();return c.jsxs($y,{$colors:t,children:[c.jsx(wn,{number:"60",children:Iy}),c.jsxs(xn,{className:"hover",children:[[...Array(yp).keys()].map(n=>c.jsx("div",{className:`slice n${n+1}`,onMouseUp:r=>r.target.blur(),tabIndex:e},n)),c.jsx("div",{className:"overlay"}),c.jsx("span",{className:"text one",children:"HOVER"}),c.jsx("span",{className:"text two",children:"HOVER"})]})]})}const re=12,ot=25,Ct=10,Ry=e=>{let t="";for(let n=1;n<re;n++)for(let r=1;r<re;r++)t+=`
      ...
      `;return t},Ty=e=>{let t="";for(let n=1;n<re;n++)for(let r=1;r<re;r++)t+=`
        .n${n}:checked {
          & ~ .n${r*re+n}::after {
            content: '';
            position: absolute;
...
`,By=c.jsxs(c.Fragment,{children:[c.jsx("p",{children:"Hover over the segments to watch them expand."}),c.jsx("div",{className:"explanation-line"}),c.jsx("p",{children:"I completed this challenge using flexbox and height manipulation on CSS events. Flexbox keeps the colored boxes organized and in place while :focus and :hover events increase the hovered box's dimensions."}),c.jsx("p",{children:"The animations are done entirely in CSS; the only JS used is to blur a box on mouse up to ensure wayward clicks don't cause two boxes to expand at once."}),c.jsx("p",{children:"The animations are fully responsive and work with both mouse and keyboard."})]}),zo=e=>{const{children:t,color:n}=e,{tabIndex:r}=et();return c.jsx("div",{className:`box ${n}`,onMouseUp:o=>o.target.blur(),tabIndex:r,children:c.jsx("span",{children:t})})};function Wy(){const{currentPalette:e}=we();return c.jsxs(Uy,{$colors:e,children:[c.jsx(wn,{number:"80",children:By}),c.jsxs(xn,{className:"segments",children:[c.jsx(zo,{color:"dark",children:"FIRST"}),c.jsx(zo,{color:"light",children:"SECOND"}),c.jsx(zo,{color:"dark",children:"THIRD"}),c.jsx(zo,{color:"light",children:"FOURTH"})]})]})}const Hy=D.div`
  position: relative;
  width: 100%;
  display: flex;
  flex-direction: column;
...
`;function Vy(){const{showExplanation:e,toggleExplanation:t}=Ma();return c.jsxs(Hy,{$blur:e,children:[c.jsxs(Bf,{children:[c.jsx(Ie,{path:"/alien",element:c.jsx(ky,{})}),c.jsx(Ie,{path:"/clock",element:c.jsx(jy,{})}),c.jsx(Ie,{path:"/flower",element:c.jsx(Ny,{})}),c.jsx(Ie,{path:"/hover",element:c.jsx(zy,{})}),c.jsx(Ie,{path:"/lights-out",element:c.jsx(My,{})}),c.jsx(Ie,{path:"/monster",element:c.jsx(Ay,{})}),c.jsx(Ie,{path:"/segments",element:c.jsx(Wy,{})})]}),c.jsxs("div",{className:"buttons",children:[c.jsx(Fe,{className:"return-link",to:"/odds-and-ends",children:"Go back"}),c.jsxs(gp,{className:"explanation-button",onClick:t,children:[e?"Hide":"See"," Explanation"]})]})]})}const Qy=D(Fa)`
  position: relative;
  display: flex;
  flex-direction: row;
  align-items: center;
...
`;function Ky(e){const{palette:t}=e,{tabIndex:n}=et(),{currentPalette:r,setPalette:o}=we(),i=M.useCallback(l=>{l.stopPropagation(),o(t)},[t,o]);return c.jsxs(Qy,{onClick:i,onKeyDown:l=>l.stopPropagation(),onMouseUp:l=>l.currentTarget.blur(),tabIndex:n,$colors:t,$selected:t.name===r.name,children:[c.jsxs("div",{className:"swatch",children:[c.jsx("div",{className:"primary"}),c.jsx("div",{className:"secondary"})]}),c.jsx("span",{children:t.name})]})}const Gy=D.div`
  display: flex;
  flex-direction: column;
...
`;function Yy(){const{palettes:e}=we();return c.jsxs(Gy,{children:[c.jsx("h2",{children:"Paint the sky"}),c.jsx("div",{className:"paints",children:e.map(t=>c.jsx(Ky,{palette:t},t.name))}),c.jsxs("span",{className:"acknowledgment",children:["Color palettes inspired by ",c.jsx(Wt,{to:"https://downwellgame.com/",children:"downwell"})]})]})}const Xy=D.div`
  display: flex;
  flex-direction: column;
  margin: 0 0 40px 0;
...
`;function Jy(e){const{desc:t,imgDesc:n,imgSrc:r,link:o,title:i}=e;return c.jsxs(Xy,{children:[c.jsx(Wt,{to:o,children:c.jsx("img",{alt:n,className:"project_card__img",src:`/projects/${r}`})}),c.jsxs("div",{className:"info",children:[c.jsx("h2",{className:"title",children:i}),c.jsxs("div",{className:"description",children:[t,c.jsxs("p",{children:["Live link: ",c.jsx(Wt,{to:o,children:i})]})]})]})]})}const Zy=D.div`
  width: 80%;
  display: flex;
  flex-direction: column;
`,qy=[{desc:c.jsxs(c.Fragment,{children:[c.jsx("p",{children:"Neon Circles is a claustrophobic shoot-em-up in the likeness of Space Invaders and Asteroids. You are stuck on the inside of a circle and can only point towards the center. To shoot the demons shooting you, you must aim through the circle and out the other side."}),c.jsx("p",{children:"Designed and built in a week, Neon Circles is both a love letter to the shoot-em-up genre and the first draft of a larger idea. It was coded solely in JS and is drawn on Canvas. All game mechanics and sprites were designed from scratch."})]}),imgDesc:`The words "Neon Circles" in an 80's style font, inside a thin circle`,imgSrc:"neon_circles.png",link:"https://atomicretro.github.io/neon_circles/",title:"Neon Circles"}];function by(){return c.jsx(Zy,{children:qy.map(e=>c.jsx(Jy,{...e},e.title))})}const e1=D.div`
  display: grid;
  grid-template-columns: auto;
...
`;function t1(){return c.jsxs(e1,{children:[c.jsxs("div",{className:"header",children:[c.jsx("h2",{children:"CSS-Only Challenges"}),c.jsx("span",{children:"Each of the below images, animations, and interactions was made entirely in CSS, unless otherwise stated in its explanation."})]}),c.jsxs("div",{className:"column c1",children:[c.jsxs("span",{children:["From ",c.jsx(Wt,{to:"https://100dayscss.com/",children:"100 Days CSS Challenge"})]}),c.jsx(Fe,{to:"/css/alien",children:"alien"}),c.jsx(Fe,{to:"/css/clock",children:"clock"}),c.jsx(Fe,{to:"/css/flower",children:"flower"}),c.jsx(Fe,{to:"/css/hover",children:"hover"}),c.jsx(Fe,{to:"/css/monster",children:"monster"}),c.jsx(Fe,{to:"/css/segments",children:"segments"})]}),c.jsxs("div",{className:"column c2",children:[c.jsx("span",{children:"From my brain"}),c.jsx(Fe,{to:"/css/lights-out",children:"light board"})]})]})}const n1=D.div`
  display: flex;
  flex-direction: column;
`;function r1(){return c.jsx(n1,{children:c.jsx(t1,{})})}const o1=D.section`
  position: relative;
  height: 100px;
  width: 100%;
  display: flex;
  ...
  overflow: auto;
  z-index: 1;
`;function i1(){return c.jsx(o1,{tabIndex:"-1",children:c.jsxs(Bf,{children:[c.jsx(Ie,{element:c.jsx(py,{}),path:"/contact"}),c.jsx(Ie,{element:c.jsx(cy,{children:c.jsx(Vy,{})}),path:"/css/*"}),c.jsx(Ie,{element:c.jsx(r1,{}),path:"/odds-and-ends"}),c.jsx(Ie,{element:c.jsx(by,{}),path:"/projects"}),c.jsx(Ie,{element:c.jsx(Yy,{}),path:"/"})]})})}const l1=D.nav`
  height: 40px;
  width: 100%;
  background-color: #ffffff;
  display: flex;
...
`;function s1(){const{handleBackgroundInteraction:e}=et(),t=n=>{n.stopPropagation(),e(!1)};return c.jsx(l1,{children:c.jsxs("div",{children:[c.jsx(Fe,{to:"/",children:"Home"}),c.jsx(Fe,{to:"/projects",children:"Projects"}),c.jsx(Fe,{to:"/odds-and-ends",children:"Odds and Ends"}),c.jsx(Fe,{to:"/contact",children:"Contact"}),c.jsx(gp,{onClick:t,children:"Stargaze"})]})})}const a1=D.section`
  height: 100%;
  width: 100%;
  display: flex;
  flex-direction: column;
...
`;function u1(){const e=oo(),{backgroundInteraction:t,showContent:n,setShowContent:r}=et();return M.useEffect(()=>{e.pathname!=="/"&&r(!0)},[]),c.jsxs(a1,{$backgroundInteraction:t,$hidden:!n,children:[c.jsx(uy,{}),c.jsx(s1,{}),c.jsx(i1,{})]})}const c1=D(Fa)`
  position: absolute;
  top: 10px;
  color: #ffffff;
  font-size: 16px;
...
`;function mc(e){const{children:t,className:n,onClick:r,tabIndex:o}=e,{currentPalette:i}=we();return c.jsx(c1,{className:n,onMouseUp:l=>l.currentTarget.blur(),onClick:r||null,tabIndex:o||"0",$colors:i,$hidden:o==="-1",children:t})}const d1=D.main`
  outline: 0;
  height: 100vh;
  width: 100vw;
  position: relative;
...
`;function f1(){const{currentPalette:e,pickRandomPalette:t}=we(),{handleBackgroundInteraction:n,showContent:r}=et(),o=i=>{i.stopPropagation(),t()};return c.jsxs(d1,{onClick:()=>n(!0),tabIndex:r?"-1":"0",children:[c.jsx(sy,{currentPalette:e}),c.jsx(u1,{}),c.jsx(mc,{className:"background-button random-palette",onClick:o,children:"Random palette"}),c.jsx(mc,{className:"background-button instructions",tabIndex:r?"-1":"0",children:"Click to enter"})]})}const p1=Zg`
  .root {
    height: 100vh;
    width: 100vw;
  }
...
`,h1=If(document.getElementById("root"));h1.render(c.jsx(X0,{children:c.jsx(Z0,{children:c.jsxs(H0,{children:[c.jsx(p1,{}),c.jsx(f1,{})]})})}));
